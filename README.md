...
This task consists on creating a pseudo-os wich calls a C function. To achieve this, you have to create a stack using assembly. Additionally, it also calls an extra function wich finds the power of them.

## Getting to C

The following is extracted from [The little book about OS development](https://littleosbook.github.io). Note that the exponent function is added by me using what I've learned and is not described in the book.
